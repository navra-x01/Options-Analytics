...
All UI logic lives directly in this file so that Streamlit
re-executes it on every interaction.
"""
...
# Core pricing and analytics modules
try:
        ...
        try:
            ...
            if missing_cols:
                ...
                if "maturity" in df.columns:
                    ...
                    try:
                        smile_df = build_volatility_smile(df_with_iv, selected_maturity, S, r)

                        # Separate calls and puts
                        calls = smile_df[smile_df["option_type"].str.lower() == "call"]
                        ...
                        fig.add_vline(
                            x=S, line_dash="dash", line_color="red", annotation_text="Spot Price"
                        )
                ...
                option_type_filter = st.selectbox(
                    "Filter by Option Type", ["All", "call", "put"], key="surface_filter"
                )
